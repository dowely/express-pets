...
router.get(
  "/admin/create-pet",
  petController.onlyAdmin,
  petController.createPetPage
);
router.post("/store-pet", petController.onlyAdmin, petController.storePet);
router.get(
  "/admin/edit-pet/:id",
  petController.onlyAdmin,
  petController.editPage
);
router.post(
  "/admin/edit-pet",
  petController.onlyAdmin,
  petController.actuallyUpdatePet
);
router.post(
  "/admin/delete-pet",
  petController.onlyAdmin,
...
router.post(
  "/admin/delete-pet-async",
  petController.onlyAdmin,
  petController.deletePetAsync
);

// contact related routes
router.post("/submit-contact", contactController.submitContect);
router.get(
