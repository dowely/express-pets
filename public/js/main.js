...
function openOverlay(el) {
  ...
  document.querySelector(".form-photo p strong").textContent = el
    .closest(".pet-card")
    .querySelector(".pet-name").textContent;
...
document
  ...
  .addEventListener("submit", async (e) => {
    ...
    document.querySelector(".thank-you").classList.add("thank-you--is-visible");

    setTimeout(closeOverlay, 2500);
    setTimeout(() => {
      document
        .querySelector(".thank-you")
        .classList.remove("thank-you--is-visible");
